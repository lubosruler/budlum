...
pub struct AccountState {
    ...
    /// Legacy marketplace (simple DataOffer model) — kept for backward compatibility.
    pub marketplace: crate::marketplace::MarketplaceRegistry,
    /// Phase 10: New comprehensive B.U.D. Data Marketplace registry (DataAsset, AccessGrant, AccessRevocation, MarketplaceListing).
    pub marketplace_v4: crate::storage::marketplace::MarketplaceRegistry,
...
impl AccountState {
    pub fn new() -> Self {
        AccountState {
            ...
            marketplace_v4: crate::storage::marketplace::MarketplaceRegistry::new(),
