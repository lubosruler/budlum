...
mod tests {
    ...
    fn challenge_answered_on_time_records_answer_with_zero_slash() {
        ...
        let cid = reg
            ...
            .unwrap();
        let res = reg
            .answer_challenge(cid, ContentId([0x42; 32]), operator(), 115)
            .unwrap();
    ...
    fn challenge_answer_after_deadline_rejected() {
        ...
        let cid = reg
            ...
            .unwrap();
        let err = reg
            .answer_challenge(cid, ContentId([0x42; 32]), operator(), 200)
            .unwrap_err();
    ...
    fn challenge_answer_by_non_operator_rejected() {
        ...
        let cid = reg
            ...
            .unwrap();
        let err = reg
            .answer_challenge(cid, ContentId([0x42; 32]), opener(), 115)
            .unwrap_err();
    ...
    fn challenge_can_only_be_resolved_once() {
        ...
        let cid = reg
            .open_challenge(deal_id, 0, 4, 110, 120, opener(), 50)
            .unwrap();
        reg.answer_challenge(cid, ContentId([0x42; 32]), operator(), 115)
            .unwrap();
