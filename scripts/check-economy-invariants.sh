...
required_tests=(
  ...
  phase11_8_priority_fee_accepted_when_within_max_fee
  ...
  phase11_8_fee_distribution_proposer_receives_tip_in_block_finalization
  ...
  phase11_8_fee_distribution_large_fee_exercises_treasury
)
