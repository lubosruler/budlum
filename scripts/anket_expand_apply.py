...
("Q117 — Harici audit firması seçim kriterleri (M7)",
 "Phase 0.43'te audit firması seçimi + kickoff var ama kriter/kapsam matrisi yok: kaç firma, hangi kapsam (kripto+consensus+ekonomi?), kim seçer. (PHASE0.42_PLAN boşluğu)",
